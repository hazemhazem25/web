                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>-</td>
                                                <td>
                                                    <a href="http://localhost/git/web/views/back office/pages/nour/client/afficherClient.php"><img src="src/icon.png" class="consult"></a>
                                                  <a href="http://localhost/git/web/views/back office/pages/nour/client/afficherClient.php"> <img src="src/sup.png" class="consult"></a>>
