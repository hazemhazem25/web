...
if ($vide==false) { 
         ...
         echo '<meta http-equiv="refresh" content="0;URL=http://localhost/git/web/views/back office/pages/nour/authentification/se_connecter.php">'; 
      } 
}	  
 
else { 
      echo "Les variables du formulaire ne sont pas déclarées.<br> Vous devez remplir le formulaire"; 
     ?> <a href="http://localhost/git/web/views/back office/pages/nour/authentification/se_connecter.php">Retour au formulaire</a>	 <?php 
}  
