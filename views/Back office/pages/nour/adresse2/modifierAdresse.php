...
if (isset($_POST["modifier"])){
	...
	if ($_POST['typeAdresse']=="aa"){
		...
		$adresse= new adresseAutre($_POST['ville'],$_POST['cite'],$_POST['rue'],$_POST['id'],$_POST['classement'],$_POST['num']);
		$adresseAutreCore=new AdresseAutreCore();
		$type="adresse autre";
		$adresseAutreCore->updateAdresse($adresse,$type);
}
	...
	if ($_POST['typeAdresse']=="al"){
		...
		$adresse= new adresseLocale($_POST['ville'],$_POST['cite'],$_POST['rue'],$_POST['id'],$_POST['classement']);
