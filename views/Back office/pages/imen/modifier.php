...
<div id="date_div"><input type="date" name="date_ajout" placeholder="" value="<?PHP echo $date_ajout; ?>"></div><div id="date_erreur"></div>
<label for="job">Date de fin:</label>
<div id="date_div"><input type="date" name="date_fin" placeholder="" value="<?PHP echo $date_fin; ?>"></div><div id="date_erreur"></div>
...
$promo=new promotion($_POST['id_produit'],$_POST['titre'],$_POST['remise'],$_POST['date_ajout'],$_POST['description'],$_POST['image'],$_POST['date_fin']);
